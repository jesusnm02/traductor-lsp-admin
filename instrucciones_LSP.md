...
Analiza el siguiente bloque de código de procesamiento, localiza las ineficiencias en el bucle de captura y procesamiento de MediaPipe, e inyecta la normalización basada en el cuello y la reducción de puntos faciales descrita anteriormente:

```python
[INSERTA AQUÍ EL CÓDIGO ACTUAL]
```
